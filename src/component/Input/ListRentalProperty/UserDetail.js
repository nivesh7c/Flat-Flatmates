  ...
  return (
    <>
      ...
      <Grid container spacing={2}>
        ...
        <Grid md={6} style={{ display: "grid" }}>
          <TextField placeholder="Last name" color="primary" size="small" required/>
        </Grid>{" "}
        <Grid md={6} style={{ display: "grid" }}>
          <TextField placeholder="Email Id" color="primary" size="small" required/>
        </Grid>{" "}
        <Grid md={6} style={{ display: "grid" }}>
          <TextField placeholder="Phone number" color="primary" size="small" required/>
        </Grid>
      </Grid>
      <div
        style={{
