...
function PropertyDetail1({setStep, flatmateDetail, setFlatMateDetail, isEdit=false}) {
  ...
  const validateStep1 = () => {
    ...
    if(!flatmateDetail?.step1?.propertyAge){
      ...
      // return false;
      errorValues.propertyAge = "Please select Property Age";
      isNotError = false;
    }
    ...
    if(!flatmateDetail?.step1?.bathrooms && flatmateDetail?.step1?.bathrooms !== 0){
  ...
  return (
    <>
      <Typography variant="h6">{isEdit ? "Edit your Rental Property Listing" : "List your Rental property with us"}</Typography>
      {!isEdit && 
      ...
      <div style={{ marginTop: "20px", marginBottom: "20px" }}>
        ...
        <StyledToggleButtonGroup
          ...
          exclusive
          value={flatmateDetail?.step1?.propertyType ? flatmateDetail?.step1?.propertyType : null}
          onChange={(event, value) => handleFormat(event, value, "propertyType")}
          aria-label="text formatting"
        >
          <NewToggleButton value="Builder Floor" key="builder">Builder Floor</NewToggleButton>
          <NewToggleButton value="High Rise Apartment" key="apartment">
            High Rise Apartment
          </NewToggleButton>
          <NewToggleButton value="Villa" key="villa">Villa</NewToggleButton>
          <NewToggleButton value="Studio" key="studio">Studio</NewToggleButton>
        </StyledToggleButtonGroup>
      </div>
